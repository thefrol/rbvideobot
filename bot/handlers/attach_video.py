...
from ..bot import bot
import settings
from .conditionals import is_a_reply, reply_to_message, from_bot,has_link_to_storage, and_
...
@bot.message_handler(func=reply_to_message(and_(from_bot,has_link_to_storage)))
def append_match_id(message:Message):
    ...
    bot.reply_to(message=message,text="debug(handlers.append_match)")